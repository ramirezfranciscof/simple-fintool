...
class CoreEngine(BaseModel):
    ...
    @staticmethod
    def rowparser(row: List[str]):
        """Parse the row into data."""
        # Convert to datetime
        ...
        return instr_name, instr_date, instr_price

    @staticmethod
    def is_weekend(input_date: date):
    ...
    def process_file(self, filepath: str):
        ...
        with open(file_path) as fileobj:
            ...
            for row in csv_reader:
                ...
                instr_name, instr_date, instr_price = CoreEngine.rowparser(row)

                # Filter out weekend days
                if CoreEngine.is_weekend(instr_date):
                    continue
